...
//            MultimodalMixer multimodalMixer = MultimodalMixer.getInstance();
...
//
//            try {
//                multimodalMixer.getMicrophoneMixer().openMic(mixerName);
//                Thread.sleep(15000);
//                multimodalMixer.getMicrophoneMixer().stop(mixerName);
