package com.monash.analytics.audio.services.microphone.channels;
...
public class ChannelDivider {
    ...
    /**
     * Current audio data (all-channels)
     */
    private final byte[] audioBuffer;
    /**
     * The number of channels (divisor)
     */
    ...
    /**
     * Constructor
     * @param audioBuffer full audio data
     * @param numberOfChannels the number of channels to divide the audio data equally
     */
